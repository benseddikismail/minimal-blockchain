...
public class Wallet {
    ...
    //returns the balance and stores the unspent UTXOs owned by this wallet in this.UTXO
    ...
    public Transaction sendFunds(PublicKey _receiver, float value) {
        if(getBalance() < value) {
            System.out.println("Not enough funds to complete the transaction. Transaction discarded");
            return null;
        }
